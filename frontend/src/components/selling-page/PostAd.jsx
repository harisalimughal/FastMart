        ...
        <div className="flex flex-col md:gap-5 gap-3">
          ...
          <div className="shadow-xl md:w-3/4 w-11/12 mx-auto md:p-10 p-5 rounded-2xl">
            <form onSubmit={handleSubmit} className="flex flex-col gap-10">
              ...
              {/* Title */}
              <div className="flex flex-col gap-4">
                <label className="md:text-2xl text-lg font-bold">Ad Title</label>
                <input
                  type="text"
                  className="border-2 border-black p-2 rounded-lg md:text-lg"
              ...
              {/* Description */}
              <div className="flex flex-col gap-4">
                <label className="md:text-2xl text-lg font-bold">Description</label>
                <textarea
                  className="border-2 border-black p-2 rounded-lg md:text-lg"
              ...
              {/* Price */}
              <div className="flex flex-col gap-4">
                <label className="md:text-2xl text-lg font-bold">Price</label>
                <div className="relative flex items-center">
                  ...
                  <input
                    ...
                    min={0}
                    step={1}
                    className="pl-10 pr-3 py-2 border-2 border-black rounded-lg md:text-lg"
              ...
              {/* Campus Location */}
              <div className="flex flex-col gap-4">
                <label className="md:text-2xl text-lg font-bold">Campus Location</label>
                <select
              ...
              {/* Name */}
              <div className="flex flex-col gap-4">
                <label className="md:text-2xl text-lg font-bold">Name</label>
                <input
                  type="text"
                  className="border-2 border-black p-2 pr-10 rounded-lg md:text-lg w-fit"
              ...
              {/* Contact */}
              <div className="flex flex-col gap-4">
                <label className="md:text-2xl text-lg font-bold">Contact</label>
                <div className="relative flex items-center">
                  <span className="absolute left-3">+92 |</span>
                  <input
                    type="text"
                    className="border-2 border-black py-2 pl-14 rounded-lg md:text-lg w-fit"
