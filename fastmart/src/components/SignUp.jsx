        ...
        <div className="w-full max-w-md rounded-xl overflow-hidden">
          ...
          <div className="flex space-x-4">
            <div className="flex flex-col w-full">
              <label htmlFor="fname" className="block text-sm text-[18px] font-medium text-gray-200 mb-2">
                First Name
              </label>
              <input
                type="text"
            ...
            <div className="flex flex-col w-full">
              <label htmlFor="lname" className="block text-sm text-[18px] font-medium text-gray-200 mb-2">
                Last Name
              </label>
              <input
                type="text"
